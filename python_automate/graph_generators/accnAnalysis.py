...
if __name__ == "__main__":
	...
	for group in grouped_results:
		bfloat_peak_accn = group["bfloat_peaks"][0][0]
		single_peak_accn = group["single_peaks"][0][0]
		double_peak_accn = group["double_peaks"][0][0]
	...
	plt.suptitle("Relative difference between peak accn across 128 extreme synthetic pulsars")
	plt.show()
