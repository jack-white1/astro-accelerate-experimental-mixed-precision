...
if __name__ == "__main__":
	...
	b2s_hist_0, s2d_hist_0, b2d_hist_0 = analysis_funcs.extract_bounded_diff_hist(grouped_results, 0, index, 0, 10000)
	b2s_hist_1, s2d_hist_1, b2d_hist_1 = analysis_funcs.extract_bounded_diff_hist(grouped_results, 0, index, 10000, 50000)
	b2s_hist_2, s2d_hist_2, b2d_hist_2 = analysis_funcs.extract_bounded_diff_hist(grouped_results, 0, index, 50000, 10000000)
	...
	plt.ylabel('Recovered SNR < 10,000')
	...
	plt.ylabel('10,000 < Recovered SNR < 50,000')
	#plt.title('BFLOAT vs SINGLE')
	...
	plt.ylabel('50,000 < Recovered SNR')
	#plt.title('BFLOAT vs SINGLE')
	...
	plt.suptitle("Relative difference between peak recovered SNR across extreme synthetic pulsars, grouped by peak height")
	plt.show()
