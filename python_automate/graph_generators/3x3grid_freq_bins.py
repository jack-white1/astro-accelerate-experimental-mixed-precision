...
if __name__ == "__main__":
	...
	for group in grouped_results:
		print("Format = [fundamental, first harmonic, second harmonic]")
		print("[[acceleration, freq, snr, freq_bin], [acceleration, freq, snr, freq_bin] ... ] ")
		print("bfloat peaks: " + str(group["bfloat_peaks"][0:3]))
		print("single peaks: " + str(group["single_peaks"][0:3]))
		print("double peaks: " + str(group["double_peaks"][0:3]))
		print("parameters: " + str(group["parameters"]))
		print("\n")
	...
	index = 3		# 0 = accn, 1 = freq, 2 = snr, 3 = freq_bin

	b2s_hist_0, s2d_hist_0, b2d_hist_0 = analysis_funcs.extract_diff_hist_freq_bin(grouped_results, 0, index)
	b2s_hist_1, s2d_hist_1, b2d_hist_1 = analysis_funcs.extract_diff_hist_freq_bin(grouped_results, 1, index)
	b2s_hist_2, s2d_hist_2, b2d_hist_2 = analysis_funcs.extract_diff_hist_freq_bin(grouped_results, 2, index)
