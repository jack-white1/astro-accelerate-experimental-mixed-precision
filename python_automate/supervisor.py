...
def makeDatFile(filepath, parameters, precision):
	...
	standardInputFilePath = '/home/jack/Documents/astro-accelerate-bfloat/python_automate/input_files/standard_input.txt'
	tempInputFilePath = '/home/jack/Documents/astro-accelerate-bfloat/python_automate/input_files/temp_input.txt'

	aaPath = {'bfloat':'/home/jack/Documents/astro-accelerate-bfloat/astro-accelerate/astro-accelerate',\
			'single':'/home/jack/Documents/astro-accelerate-single/astro-accelerate/astro-accelerate',
			'double':'/home/jack/Documents/astro-accelerate-double/astro-accelerate/astro-accelerate'}
	...
	#lower harmonic detection


	#higher harmonic detection


	#harmonic sum

	results = {"[accn, freq, snr]":max_result,'precision':precision,"filFilePath":filepath,"aaOutputDatFileName":aaOutputDatFileName}
...
#
	with open("aaToDoList.txt", "a") as f:
		...
		f.write('{"filepath": "/home/jack/hdd/fil/period_22.9_width_50.0_snrpeak_5_dm_50_nbits_8_nchans_1024_tsamp_128_tobs_600_fch1_1550_foff_0.292968752_09-08-2021-23-34-29.998354_.fil", "parameters": {"period": 22.9, "width": 50.0, "snrpeak": 5, "dm": 50, "nbits": 8, "nchans": 1024, "tsamp": 128, "tobs": 600, "fch1": 1550, "foff": 0.292968752}}')
