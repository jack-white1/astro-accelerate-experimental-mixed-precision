...
#define SLIGHT 299792458.0
  ...
  typedef struct{
    double           *d_in_signal;
    cufftDoubleComplex  *d_fft_signal;
    double2  *d_ext_data;
    double2  *d_kernel;
    double   *d_ffdot_pwr;
  ...
  void fdas_create_double_acc_kernels(double2* d_kernel, cufftComplex* temp_kernel_pointer, cmd_args *cmdargs );
...
*/
  ...
  //cudaError_t deep_convert_double2_to_float2(float2 *dest_ptr, double2 *source_ptr, size_t source_len);

  //cudaError_t deep_convert_double_to_float(float *dest_ptr, double *source_ptr, size_t source_len);

  cudaError_t fast_cast_double_to_float(float *dest_ptr, double *source_ptr, size_t source_len);

  cudaError_t fast_cast_double2_to_float2(float2 *dest_ptr, double2 *source_ptr, size_t source_len);
